...
import org.tensorflow.posemon.ml.PoseNet
...
class PosenetTest {
    ...
    fun testPoseEstimationResultWithImage1() {
        val input = airost.teamrocket.lite.examples.posturedetect.ml.EvaluationUtils.loadBitmapAssetByName(TEST_INPUT_IMAGE1)
    ...
    fun testPoseEstimationResultWithImage2() {
        val input = airost.teamrocket.lite.examples.posturedetect.ml.EvaluationUtils.loadBitmapAssetByName(TEST_INPUT_IMAGE2)
        val person = poseDetector.estimatePoses(input)[0]
        airost.teamrocket.lite.examples.posturedetect.ml.EvaluationUtils.assertPoseDetectionResult(
            person,
