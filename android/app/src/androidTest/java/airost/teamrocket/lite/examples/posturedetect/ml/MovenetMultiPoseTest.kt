...
package airost.teamrocket.lite.examples.posturedetect.ml
...
class MovenetMultiPoseTest {
    ...
    fun setup() {
        ...
        val input1 = airost.teamrocket.lite.examples.posturedetect.ml.EvaluationUtils.loadBitmapAssetByName(TEST_INPUT_IMAGE1)
        val input2 = airost.teamrocket.lite.examples.posturedetect.ml.EvaluationUtils.loadBitmapAssetByName(TEST_INPUT_IMAGE2)
        inputFinal = airost.teamrocket.lite.examples.posturedetect.ml.EvaluationUtils.hConcat(input1, input2)
        expectedDetectionResult =
                airost.teamrocket.lite.examples.posturedetect.ml.EvaluationUtils.loadCSVAsset("pose_landmark_truth.csv")
    ...
    fun testPoseEstimateResult() {
        ...
        airost.teamrocket.lite.examples.posturedetect.ml.EvaluationUtils.assertPoseDetectionResult(
                sortedPersons[0],
